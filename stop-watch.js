console.log('hello world - stop-watch.js connected');

// dom elements declared by id
var restartButton = document.getElementById('stop-watch-restart');
var startButton = document.getElementById('stop-watch-start');
var pauseButton = document.getElementById('stop-watch-pause');
var timerDisplay = document.getElementById('stop-watch-display');
...
var convertToHHMMSS = function(timerCount) {
    ...
    console.log('stop watch counting')
